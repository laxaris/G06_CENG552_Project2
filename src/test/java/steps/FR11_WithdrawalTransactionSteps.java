...
public class FR11_WithdrawalTransactionSteps {
    ...
    @When("the user enters the correct password and authorizatin succeds \\(FR11)")
    public void fr11_the_user_enters_the_correct_password() {
    ...
    public void fr11_the_withdrawal_sequence_should_begin() {
     
    }
    @Then("the withdrawal should not proceed \\(FR11)")
    public void fr11_the_withdrawal_should_not_proceed() {
